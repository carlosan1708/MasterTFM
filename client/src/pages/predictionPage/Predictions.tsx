      ...
      <Grid container item xs={10}>
        ...
        <Grid  item xs={12}>
          <CustomGoogleMap
            ...
            <Button style={{marginTop: '2rem'}} size="large" variant={'contained'}onClick={generatePrediction}>Predict Solar</Button>
            </Grid>
        </Grid>
        {matchesUp &&
        <Grid item xs={1}>
        ...
        {segmentationImage && 
          <img src={`data:image/jpeg;base64,${segmentationImage}`} alt="predictionImage" />
        }
        </Grid>
      </Grid>
